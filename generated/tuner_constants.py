...
class TunerConstants:
    ...
    _front_left_encoder_offset: units.rotation = 0.20361328125
    _front_left_steer_motor_inverted = False
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(16)
    _front_left_y_pos: units.meter = inchesToMeters(13.5)

    # Front Right
    _front_right_drive_motor_id = 1
    _front_right_steer_motor_id = 3
    _front_right_encoder_id = 13
    _front_right_encoder_offset: units.rotation = -0.131591796875
    _front_right_steer_motor_inverted = False
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(16)
    _front_right_y_pos: units.meter = inchesToMeters(-13.5)

    # Back Left
    _back_left_drive_motor_id = 5
    _back_left_steer_motor_id = 6
    _back_left_encoder_id = 14
    _back_left_encoder_offset: units.rotation = -0.052734375
    _back_left_steer_motor_inverted = False
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-16)
    _back_left_y_pos: units.meter = inchesToMeters(13.5)

    # Back Right
    _back_right_drive_motor_id = 2
    _back_right_steer_motor_id = 4
    _back_right_encoder_id = 15
    _back_right_encoder_offset: units.rotation = 0.1962890625
    _back_right_steer_motor_inverted = False
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-16)
    _back_right_y_pos: units.meter = inchesToMeters(-13.5)
